...
- **Installation Method** - DevTunnel now exclusively uses npm for installation (`npm i -g devtunnel-cli`)
...
- **npm Install Path Issue** - Fixed module resolution error when installed via `npm i -g devtunnel-cli`
